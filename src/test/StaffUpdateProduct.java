...
public class StaffUpdateProduct extends javax.swing.JFrame {
    ...
    public StaffUpdateProduct(Staff currentStaff,
...
public void StoreData(){
    ...
    private void jbtUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtUpdateActionPerformed
        for(int i=0;i<productList.getNumberOfEntries();i++){
            if(productList.getEntry(i+1).getId().equals(jtfProductID.getText())){
                
                productList.replaceProd(i+1,
                        new Product(jtfProductID.getText(),
                                    jtfProductName.getText(),
                                    jtfProductType.getText(),
                                    jtaDesc.getText(),
                                    Double.parseDouble(jtfPrice.getText()),
                                    Integer.parseInt(jtfQuan.getText())));
