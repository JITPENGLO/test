...
public class DeliveryHistory extends javax.swing.JFrame {
    ...
    public DeliveryHistory(Customer currentCust,
    ...
    public void addRowToTable(){
        ...
        for(int i=0; i<orderList.getNumberOfEntries(); i++){
            rowData[0] = orderList.getEntry(i+1).getOrderID();
            rowData[1] = orderList.getEntry(i+1).getProduct().getId();
            rowData[2] = orderList.getEntry(i+1).getQuantity();
            rowData[3] = orderList.getEntry(i+1).getTotalPrice();
            rowData[4] = orderList.getEntry(i+1).getAddress();
            rowData[5] = orderList.getEntry(i+1).getPostCode();
            rowData[6] = orderList.getEntry(i+1).getCity();
            rowData[7] = orderList.getEntry(i+1).getDate();
            rowData[8] = orderList.getEntry(i+1).getStatus();
    ...
    private void initComponents() {
        ...
        jtfCity.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jtfCity.setForeground(new java.awt.Color(102, 102, 102));
        jtfCity.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jtfRM.setText("PostCode      :");
        jtfRM.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));

        lblQuan.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblQuan.setText("Address        :");

        jtfCode.setEditable(false);
        jtfCode.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jtfCode.setForeground(new java.awt.Color(102, 102, 102));
        jtfCode.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jtbProduct.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Product Name", "Quantity", "Price", "Address", "PostCode", "City", "Date", "Status"
            }
        ) {
    ...
    private void jbtUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtUpdateActionPerformed
        ...
        if(yes == JOptionPane.YES_OPTION){
            for(int i=0; i<orderList.getNumberOfEntries(); i++){
                if(jtfID.getText().equals(orderList.getEntry(i+1).getOrderID())){ 
                        product.setId(jtfName.getText());
                        //orderList.replace(i+1, new Delivery(jtfID.getText(), product, Integer.parseInt(jtfQuan.getText()), Double.parseDouble(jtfTotal.getText()), currentCust, jcbStatus.getSelectedItem().toString(), jtaAddress.getText(), Integer.parseInt(jtfCode.getText()), jtfCity.getText(), jtfDate.getText()));
                        orderList.getEntry(i+1).setStatus(jcbStatus.getSelectedItem().toString());
                        break;
                }
            }
            JOptionPane.showMessageDialog(null, "Record updated!", "DELETED", JOptionPane.INFORMATION_MESSAGE);
            RefreshTable();
        }
        else{
            jtfID.setText("");
...
public void RefreshTable(){
        ...
        for(int i=0; i<orderList.getNumberOfEntries(); i++){
            model.addRow(new Object[]{
                orderList.getEntry(i+1).getOrderID(),
                orderList.getEntry(i+1).getProduct(),
                orderList.getEntry(i+1).getQuantity(),
                orderList.getEntry(i+1).getTotalPrice(),
                orderList.getEntry(i+1).getAddress(),
                orderList.getEntry(i+1).getPostCode(),
                orderList.getEntry(i+1).getCity(),
                orderList.getEntry(i+1).getDate(),
                orderList.getEntry(i+1).getStatus()});
            }
    }
    ...
    private void jtbProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbProductMouseClicked
        ...
        jtfTotal.setText(model.getValueAt(selectedRow, 3).toString());
        jtaAddress.setText(model.getValueAt(selectedRow, 4).toString());
        jtfCode.setText(model.getValueAt(selectedRow, 5).toString());
        jtfCity.setText(model.getValueAt(selectedRow, 6).toString());
        jtfDate.setText(model.getValueAt(selectedRow, 7).toString());
        jcbStatus.setSelectedItem(model.getValueAt(selectedRow, 8).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeliveryHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeliveryHistory().setVisible(true);
            }
        });
    }
